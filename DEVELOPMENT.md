...
出力は `.another-mood/{project}/output/` に書き出される。起点は [.another-mood/dev-docs/output/prose/index.md](.another-mood/dev-docs/output/prose/index.md)。
...
- [index.md](.another-mood/dev-docs/output/prose/index.md) — 全体インデックス
- [design/index.md](.another-mood/dev-docs/output/prose/design/index.md) — 設計仕様インデックス
...
- [index.md](.another-mood/dev-docs/output/prose/index.md) — 仕様・設計
- [background/product.md](.another-mood/dev-docs/output/prose/background/product.md) — 製品ビジョン
- [internal/architecture.md](.another-mood/dev-docs/output/prose/internal/architecture.md) — アーキテクチャ
- [roadmap.md](.another-mood/dev-docs/output/roadmap.md) — ロードマップ（Phase 8 以降）
- [tasks.md](.another-mood/dev-docs/output/tasks.md) — タスクカタログ（機能カテゴリ別）
