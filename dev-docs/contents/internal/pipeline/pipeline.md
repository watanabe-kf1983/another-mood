...
|---|---|---|---|
| inspect_schema | schemas_dir | — | inspect_schemas_dir |
| normalize_contents | contents_dir, schemas_dir ※1 | inspect_schemas_dir | normalize_contents_dir |
| normalize_queries | queries_dir | inspect_schemas_dir | normalize_queries_dir |
| compose | — | inspect_schemas_dir ※2, normalize_contents_dir, normalize_queries_dir | compose_dir |
...
- ※1 schemas_dir: バリデーションルールの読み込みに使うが、変更は SchemaInspector → inspect_schemas_dir の経路で伝播するため Watch 不要
