...
|---|---|---|---|
| inspect_schema | schema_dir | — | inspect_schemas_dir |
| normalize_contents | contents_dir, schema_dir ※1 | inspect_schemas_dir | normalize_contents_dir |
...
- ※1 schema_dir: バリデーションルールの読み込みに使うが、変更は SchemaInspector → inspect_schemas_dir の経路で伝播するため Watch 不要
