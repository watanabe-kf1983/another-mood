...
詳細は [docs-src/contents/dev/environment.md](../docs-src/contents/dev/environment.md) を参照。

## 使い方

1. VSCode で「Reopen in Container」を選択
2. 初回は postCreateCommand で Claude Code CLI 等が自動インストールされる
3. 動作確認は [docs-src/contents/dev/environment.md の確認手順](../docs-src/contents/dev/environment.md#動作確認) を参照
