...
元々は「要件定義を省力化するツール（another-mood）」として構想。
...
詳細な経緯: [another-mood-original.md](another-mood-original.md)

## Key Concepts

- **Schema**: データ構造を定義（JSON Schema）。参照関係は `references.yaml` に独立定義
...
- **Document Generator**: テンプレート展開 + ページ分割
